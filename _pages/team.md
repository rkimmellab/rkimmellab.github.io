...
<ul style="list-style: none; padding: 0;">
  <li style="display: flex; align-items: flex-start; margin-bottom: 20px;">
    <img src="{{ site.url }}{{ site.baseurl }}/images/Pauline_Bicker_Picture.jpeg" class="img-responsive" style="width: 150px; height: auto; margin-right: 20px;" />
    <div>
